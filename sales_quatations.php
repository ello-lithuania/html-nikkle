    ...
    <div class="bg-[#EBF4F8] py-[16px] pb-[48px] px-[9px] lg:p-[27px] lg:rounded-[40px] w-full lg:mr-[40px]">
        ...
        <div class="bg-gradient-white2 p-[19px] md:p-[35px] rounded-[20px]">
            <div class="flex justify-between items-center mb-[23px] flex-wrap md:flex-nowrap">
                <h2 class="text-[20px] leading-[24px] text-[#003F6C] font-semibold">Quotations</h2>
                            <a href="" class="w-full md:w-auto justify-center md:justify-start mt-[28px] md:mt-0 whitespace-nowrap montserrat flex items-center py-[16px] px-[14px] rounded-[10px] bg-[#408FEF1A]  hover:bg-[#408FEF]/20 text-[#0D7AFF] font-semibold text-[14px] leading-[17px]">
            ...
            <div class="flex-wrap md:no-wrap flex mb-[34px]">
                <div class="mb-[20px] md:mb-0 md:mr-[20px] custom-select custom-select11">
                ...
                <div class="w-full md:w-auto">
                    ...
                    <input value="01/01/2018 - 01/15/2018" type="text" name="daterange" class="bg-white w-full md:w-auto input-datepicker box-shadow outline-0 min-w-[337px] max-w-[100%] montserrat font-semibold text-[14px] leading-[17px] text-[#3E3E3E] text-sm rounded-[10px] block px-[14px] py-[18px]" placeholder="Select date">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 gap-[15px] items-center py-[14px] pl-[17px] hidden md:grid bg-silver-light rounded-[10px]">
                <div class="col-span-2">
                    <p class="text-[#A9AFB5] text-[10px] leading-[15px] tracking-[1px] font-semibold inline uppercase">Status</p>
                </div>
                <div class="col-span-2">
            ...
            <div class="grid grid-cols-11 md:grid-cols-12 gap-[15px] items-center py-[17px] md:pl-[17px] items-center">
                <div class="col-span-3 md:col-span-2">
                    <p class="text-[#901740] montsserrat font-bold text-[10px] leading-[12px] px-[13px] py-[5px] bg-[#FFE7EF] rounded-[10px] inline-flex items-center justify-center">EXPIRE</p>
                ...
                <div class="col-span-6 md:col-span-2 hidden md:block">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px]">20230314323</p>
                </div>
                <div class="col-span-3 md:col-span-2">
                ...
                <div class="col-span-3 md:col-span-2 text-center md:text-left">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px]">N$ 8900.00</p>
                </div>
                <div class="col-span-2 md:col-span-2 relative text-center flex justify-end md:items-center md:justify-center">
