    ...
    <div class="bg-[#EBF4F8] py-[16px] pb-[48px] px-[9px] lg:p-[27px] lg:rounded-[40px] w-full lg:mr-[40px]">
        ...
        <div class="bg-gradient-white2 p-[19px] md:p-[35px] rounded-[20px]">
            <div class="flex justify-between items-center mb-[23px] flex-wrap md:flex-nowrap">
                <h2 class="text-[20px] leading-[24px] text-[#003F6C] font-semibold">Product & Services</h2>
            ...
            <div class="grid grid-cols-11 md:grid-cols-12 gap-[15px] items-center py-[17px] md:px-[17px]">
                ...
                <div class="col-span-3 md:col-span-3 text-center md:text-left">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px]">Netherlands</p>
                </div>
                <div class="col-span-3 md:col-span-3 text-center md:text-left">
                    <p class="text-[#901740] montsserrat font-bold text-[10px] leading-[12px] px-[13px] py-[5px] bg-[#FFE7EF] rounded-[10px] inline-flex items-center justify-center">Sales</p>
                </div>
