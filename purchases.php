    ...
    <div class="bg-[#EBF4F8] py-[16px] pb-[48px] px-[9px] lg:p-[27px] lg:rounded-[40px] w-full lg:mr-[40px]">
        ...
        <div class="bg-gradient-white2 p-[19px] py-[32px] md:p-[35px] rounded-[20px]">
            <div class="flex justify-between items-center mb-[23px] flex-wrap md:flex-nowrap">
                <h2 class="mb-[28px] md:mb-0 text-[20px] leading-[24px] text-[#003F6C] font-semibold">Vendors</h2>
            ...
            <div class="grid grid-cols-12 gap-[15px] items-center py-[20px] md:py-[17px] md:px-[17px]">
                ...
                <div class="col-span-0 md:col-span-3 text-right md:text-left hidden md:grid">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px] m-0">09766023401</p>
                </div>
                <div class="col-span-7 md:col-span-3 text-right md:text-left">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px] m-0">test.name@mail.com</p>
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px] m-0 md:hidden mt-[8px]">+09766023401</p>
                </div>
