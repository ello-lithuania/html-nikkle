...
<div class="flex md:pb-[84px]">
    ...
    <div class="bg-[#EBF4F8] py-[16px] pb-[48px] px-[9px] lg:p-[27px] lg:rounded-[40px] w-full lg:mr-[40px]">
        ...
        <div class="bg-gradient-white2 px-[21px] py-[26px] md:p-[35px] rounded-[20px]">
            ...
            <div class="flex justify-between items-center mb-[43px]">
                <h2 class="text-[20px] leading-[24px] text-[#003F6C] font-semibold">Invoice Customization</h2>       
            </div>

            <div class="grid grid-cols-12 md:gap-[83px] mb-[35px]">
                <div class="col-span-12 md:col-span-8">
                    <p class="mb-[13px] text-[14px] leading-[21px] text-[#3E3E3E]">Choose invoice templates</p>
                    
                    <div class="grid grid-cols-12 gap-[14px]">
                        <div class="col-span-6 md:col-span-3">
                            <div class="rounded-[15px] bg-[#000000]/5 p-[8px] template-body">
                                <img src="./img/invoice-template.jpg" class="rounded-[10px]"/>
                                <h4 class="text-center font-semibold text-[14px] leading-[21px] mb-[2px] text-[#3E3E3E] mt-[11px]">Template 2</h4>
                            </div>
                        </div>
                        <div class="col-span-6 md:col-span-3">
                            <div class="rounded-[15px] bg-[#000000]/5 p-[8px] template-body">
                ...
                <div class="col-span-12 md:col-span-4 mt-[36px] md:mt-0">
                    <p class="mb-[13px] text-[14px] leading-[21px] text-[#3E3E3E]">Accent color</p>
                    <p class="text-[#003F6C] text-[16px] leading-[24px] mb-0 flex items-center border border-[#D9D9D9] rounded-[10px] py-[13px] px-[11px] max-w-[162px]"><span class="bg-[#B478D9] w-[32px] h-[32px] rounded-full mr-[13px] inline-block"></span>#546af1</p>
                </div>
            </div>

            <hr class="bg-[#E4E4E4]"/>

            <div class="grid grid-cols-12 md:gap-[88px] my-[35px]">
                <div class="col-span-12 md:col-span-4">
                    <div class="flex flex-row mb-[14px]">
                        <input class="rounded-[6px] w-[21px] h-[21px] mr-[15px]" type="checkbox" id="scales" name="scales" checked>
                        <label class="text-[14px] leading-[21px] text-[#3E3E3E]">Enable invoice QR code</label>
                    </div>
                    <p class="text-[#A9AFB5] text-[11px] leading-[16.5px] mb-0">Enable to generate and show QR code for all created invoices</p>
                </div>
                <div class="col-span-12 md:col-span-4 mt-[15px] md:mt-0">
                    <div class="flex flex-row mb-[14px]">
                        <input class="rounded-[6px] w-[21px] h-[21px] mr-[15px]" type="checkbox" id="scales" name="scales" checked>
                        <label class="text-[14px] leading-[21px] text-[#3E3E3E]">Enable product stock</label>
                    </div>
                    <p class="text-[#A9AFB5] text-[11px] leading-[16.5px] mb-0">Enable this feature you will be able to manage your products stock in invoices.</p>
                </div>
            </div>

            <hr class="bg-[#E4E4E4]"/>

            <h3 class="text-[#3E3E3E] text-[14px] leading-[21px] mb-[20px] mt-[35px]">Set default footer note for invoice</h3>
   ...
   <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                ...
                <div class="text-right flex items-end justify-end mt-[25px] md:mt-0">
                    <button class="bg-[#003F6C] w-full md:w-auto hover:bg-[#002743] box-shadow min-w-[180px] text-white rounded-[10px] montserrat font-semibold text-[14px] leading-[17px] px-[37px] py-[15px]">Save</button>
                </div>
