...
<div class="flex md:pb-[84px]">
    ...
    <div class="bg-[#EBF4F8] py-[16px] pb-[48px] px-[9px] lg:p-[27px] lg:rounded-[40px] w-full lg:mr-[40px]">
        ...
        <div class="bg-gradient-white2 px-[21px] py-[26px] md:p-[35px] rounded-[20px]">
            ...
            <h2 class="text-[#003F6C] font-semibold text-[24px] leading-[36px] mb-[28px]">All Roles</h2>

            <div class="flex flex-wrap md:no-wrap justify-between items-center mb-[23px] rounded-[10px]">
                            <form class="bg-white w-full md:w-auto py-[11px] px-[17px] flex items-center overflow-hidden rounded-[10px] md:min-w-[268px]">
                                <input placeholder="Search roles..." class="placeholder:text-[#A9AFB5] color-black text-[16px] leading-[24px] outline-0 flex-grow pr-[10px]"/>
                                <button><img src="./img/icon-search-blue.svg"/></button>
                            </form>
                            <a href="" class="mt-[20px] md:mt-0 w-full md:w-auto justify-center md:justify-start whitespace-nowrap montserrat flex items-center py-[16px] px-[14px] rounded-[10px] bg-[#408FEF1A]  hover:bg-[#408FEF]/20 text-[#0D7AFF] font-semibold text-[14px] leading-[17px]">
            ...
            <div class="grid grid-cols-12 gap-[15px] items-center py-[14px] pl-[17px] hidden md:grid bg-silver-light rounded-[10px]">
                ...
                <div class="col-span-3">
                    <p class="text-[#A9AFB5] text-[10px] leading-[15px] tracking-[1px] font-semibold inline uppercase">DISPLAY NAME</p>
                </div>
            ...
            <div class="grid grid-cols-12 gap-[15px] items-center py-[17px] md:px-[17px]">
                <div class="col-span-10 md:col-span-3">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px] mr-[35px] hidden md:inline">1</p>
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px] font-semibold inline">Sales Agent</p>
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px] mt-[5px] md:hidden">Kilian Hakweenda</p>
                </div>
                <div class="col-span-6 md:col-span-3 text-right md:text-left hidden md:block">
                    <p class="text-[#3E3E3E] text-[14px] leading-[21px]">Kilian Hakweenda</p>
                </div>
